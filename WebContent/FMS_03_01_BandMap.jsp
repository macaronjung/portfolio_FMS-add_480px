...
<link rel="stylesheet" type="text/css" href="JDH/css/media_BandMap.css" />
          ...
          <div class="sec-mapbox mapbox">
            ...
            <script>
					...
					/* 마커표시 시작 */
							...
							var iwContent2 = '<div style="padding: 10px 0 0 10px;color:black;font-size: 0.7em;">더블듀스(DoubleDeuce) 연습실<br><a href="https://map.kakao.com/link/map/더블듀스(DoubleDeuce) 연습실,37.558450, 126.934049" style="color:blue" target="_blank"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 큰지도보기</a> <a href="https://map.kakao.com/link/to/더블듀스(DoubleDeuce) 연습실,37.558450, 126.934049" style="color:gold" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
      ...
      <section class="mainbox">
        ...
        <div class="sec2 sec">
          ...
          /* 마커표시 시작 */
              ...
              var iwContent2 = '<div style="padding: 6px 3px 0 8px;color:black;font-size: 0.7em;">더블듀스(DoubleDeuce) 연습실<br><a href="https://map.kakao.com/link/map/더블듀스(DoubleDeuce) 연습실,37.558450, 126.934049" style="color:blue" target="_blank"> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; 큰지도보기</a> <a href="https://map.kakao.com/link/to/더블듀스(DoubleDeuce) 연습실,37.558450, 126.934049" style="color:gold" target="_blank">길찾기</a></div>', // 인포윈도우에 표출될 내용으로 HTML 문자열이나 document element가 가능합니다
              iwPosition2 = new kakao.maps.LatLng(37.558450, 126.934049); //인포윈도우 표시 위치입니다
